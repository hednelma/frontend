...
import doRegister from "../../função/visitante/fazerRegisto"
    ...
    return (
        <View style={loginStyles.container}>
            ...
            <View style={loginStyles.containerText}>
                ...
                <TouchableOpacity onPress={()=> doRegister(name, email, password, confirmPassword, setError, navigation, setIsAuthenticated, setUser,)} style={loginStyles.btn}>
