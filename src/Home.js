          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity onPress={() => navigation.navigate('verProfissional', { profissional: item })} style={homeStyles.prof_item}>
                <Image source={{ uri: item.foto ? `http:///194.210.90.33:4041/cliente/${item.foto}` :  `http:///194.210.90.33:4041/cliente/uploads/image.jpg  `}} style={homeStyles.circle} />
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity  onPress={()=> navigation.navigate('verServico', {service:item})}style={homeStyles.prof_item}>
                <Image source={{ uri: item.imagem ? `http:///194.210.90.33:4041/cliente/${item.imagem}` :  `http:///194.210.90.33:4041/cliente/uploads/image.jpg  `}} style={homeStyles.circle} />
